...
<sub>같은 비교의 영상판 — 1760×1672, 60 fps, 0.5배속, 6초. 재생을 누르세요. 아래 GIF는 같은 내용으로, 영상을 렌더링하지 않는 곳을 위한 것입니다.</sub>

<p align="center"><img src="assets/video-clip-stitching-seam-raw-join-vs-final-cut-half-speed-loop.gif" alt="같은 이음새를 움직임으로, 0.5배속, 반복" width="880"></p>
